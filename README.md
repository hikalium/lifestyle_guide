...
状況別に具体的にとるべきアクションとその直接的背景を書いた。

アクセス頻度が高いと思われるものから順に書くこと。
...
### おなかが痛い/痛くなりそうなとき
- つらいコンテンツの摂取をやめる（心理的ダメージの大きいアニメを見るなど）
- ストレスのかかる行動をしているならやめること（アクション系のゲームなど）
- キリキリ痛む場合はブスコパンを摂取する（胃腸の過活動を抑制）
- 水を飲む
- 食べ物は食べたいなら少量とってもよいが、極力食べない。大量に食べるのは絶対に避ける。アイスも避ける。
- 湿度と温度が快適か確認し、そうでなければ改善策を少し強めに講じる（エアコン温度変更、加湿器オン等）
- 葉を磨いて、とりあえず眠る。お風呂に入るのをスキップしてよい。（温めると胃腸が活発になりトイレに行きたくなる可能性が高まるが、お風呂上がってすぐトイレに行くと気化熱で冷えておしまいになる可能性があるため）
...
### 体調が悪くなりそうなとき
- 足が冷たいなら靴下を履く
- 暑さを感じないならパーカーを着て使い捨てカイロをおなかに貼る
- 冬季や夜なら暖房の温度を1段階上げてみる
- いま水をコップ1杯分飲んでおく
- 早めに寝る。眠くなくても、睡眠準備を終わらせる。
- あらゆる電子ディスプレイをみないよう努力する。

### のどが痛い
- 水を多少飲んでから、龍角散ダイレクトトローチをなめる。
...
### おふろに入るとき
- 洗濯物をついでに回収しておく。
- 着替える先の服が存在していることを確かめる。
- バスタオルを脱衣所に用意する。
- 放置すると危険な機器を停止させる（ヒーター、はんだごて、ガスコンロ等）

## 理論

直接の行動指針ではないが、それを立てるために役立つかもしれない情報をここに記す。
